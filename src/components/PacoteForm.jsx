...
// const PacoteForm = ({ onSave }) => {
//   const pacotesPredefinidos = {
//     levarBuscar: [
//       { nome: 'Pacote mensal 4 banhos', preco: 120.0 },
//       { nome: 'Pacote quinzenal 2 banhos', preco: 80.0 },
//     ],
//     praBuscar: [
//       { nome: 'Pacote mensal 4 banhos', preco: 125.0 },
//       { nome: 'Pacote quinzenal 2 banhos', preco: 85.0 },
//     ],
//     banhosTosasAvulso: [
//       { nome: 'Banho e tosa higiênica', preco: 50.0 },
//       { nome: 'Banho e tosa corpo', preco: 60.0 },
//     ],
//   };
...
//   const tiposServico = [
//     { value: 'levarBuscar', label: 'Levar e buscar' },
//     { value: 'praBuscar', label: 'Pra buscar (taxipet)' },
//     { value: 'banhosTosasAvulso', label: 'Banhos e tosas avulso' },
//   ];
...
//   const handleNomePacoteChange = (event) => {
//     const selectedPacote = pacotesPredefinidos[tipoServico].find(
//       (pacote) => pacote.nome === event.target.value
//     );
//     setNomePacote(selectedPacote.nome);
//     setPreco(selectedPacote.preco);
//   };

//   const handleSave = () => {
//     if (!tipoServico || !nomePacote || !preco) return;

//     const pacote = { tipoServico, nomePacote, preco: parseFloat(preco) };
//     onSave(pacote);
//   };
...
//               <Select value={tipoServico} onChange={handleTipoServicoChange}>
...
//             <Grid item xs={12}>
//               <FormControl fullWidth>
//                 <InputLabel>Nome do Pacote</InputLabel>
//                 <Select value={nomePacote} onChange={handleNomePacoteChange}>
//                   {pacotesPredefinidos[tipoServico].map((pacote) => (
//                     <MenuItem key={pacote.nome} value={pacote.nome}>
//                       {pacote.nome}
//                     </MenuItem>
//                   ))}
//                 </Select>
...
//               color="primary"
//               onClick={handleSave}
//               disabled={!tipoServico || !nomePacote || !preco}
//             >
//               Adicionar Pacote
//             </Button>
//           </Grid>
